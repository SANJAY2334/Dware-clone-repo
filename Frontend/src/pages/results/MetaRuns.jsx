...
const MetaRuns = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h2 className="text-2xl font-bold text-gray-900">Results – Compare Runs</h2>
      ...
      <div className="flex justify-end space-x-3 mt-5">
        ...
        <button onClick={handleDelete} className={`flex items-center space-x-2 px-4 py-2 rounded-md ${
          ...
          <thead className="bg-gray-200 text-gray-700">
            <tr>
              <th className="p-3 text-left">
                <input type="checkbox" onChange={(e) => setSelectedRows(e.target.checked ? data.map((row) => row.id) : [])}
