    ...
    <div className="p-6 bg-white rounded-xl shadow-md">
      ...
      <div className="flex flex-wrap gap-3 mb-5">
        ...
        <button
          ...
          className={"px-4 py-2 bg-gray-500 text-white rounded-md flex items-center gap-2 hover:bg-gray-700"
            }
        >
          <FaTrash /> Delete
        </button>
        ...
        <button
          ...
          className="px-4 py-2 rounded-md flex items-center text-white bg-gray-500 gap-2 hover:bg-gray-700" 
        >
          <FaPlay /> Run
        </button>
